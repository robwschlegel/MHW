...
\begin{abstract}
Changing climates place shallow water ecosystems, found along nearly every coastline of the world, at more risk than those in the open ocean as their temperatures may change more rapidly and dramatically. To this end it is necessary that we identify the occurrence of extreme ocean temperature events, referred to here as Marine Heatwaves (MHWs) and Marine Cold-Spells (MCSs), in the nearshore environment as both strong warm and cold events may be damaging to local flora and fauna. To do so we have taken a recently developed algorithm that defines these extreme events in a novel way. We applied this algorithm to ocean temperature time series from i) daily nearshore \emph{in situ} data collected along the coast of South Africa that are longer than 10 years and with at least 90\% complete daily records and ii) daily offshore NOAA Optimally Interpolated sea surface temperature data (OISST) that are 33 years long. The coastline was then divided into three sections (west, south and east) to investigate the effect of geography and differing oceanographic conditions on MHWs and MCSs. Whereas it is known that MHWs occur, any changes in their count and intensity over time is not well documented however; nearly all aspects of MCSs have yet to be determined and the potential phenomena that may contribute most to either warm or cold events is not well studied. By analysing both nearshore and offshore temperature data around southern Africa we were able to calculate the extreme events and then use these data to further understand the impact offshore temperatures may be having on the nearshore and \emph{vice versa} by matching extreme events in time and space between the different datasets. Here we show that extreme ocean temperature events occur at least once a year on average within each coastal section with some temporal and spatial agreement between the largest events detected in both datasets but that the rates of co-occurrence between the datasets are low at 0.20 -- 0.50 with MHWs having greater rates of co-occurrence than MCSs. It was also found that the east coast experience shorter MHWs and MCSs than the other two coasts whereas the mean intensity of MHWs was significantly smaller on the south coast while the mean intensity of MCSs was significantly larger than the other two coasts. These significant differences in duration and mean intensities are attributed to the effects of the interaction of the Agulhas and Benguela currents with each other and with the distinct local geography of each coast. The decadal trends in MHWs and MCSs for each coast in the offshore dataset agree with the trends atmospheric climate change scientists have been documenting for over a decade in that the warm events are increasing while the cold events are decreasing. We have determined that the MCS algorithm used in this study is not an effective method of detecting upwelling. This study represents an important first step in the analysis of extreme events in nearshore environments and what is driving them. The low co-occurrence rates between the nearshore and offshore datasets shows that the mesoscale ocean temperatures are likely not the main driver affecting extreme events on the nearshore. We believe that atmospheric temperature forcing may be having a greater impact on the extreme temperatures in these shallow ecosystems.
\end{abstract}

\begin{keyword}
marine heatwaves \sep marine cold-spells \sep remotely-sensed SST \sep \emph{in situ} data \sep climate change \sep coastal
\end{keyword}
...
In order to calculate the decadal trends in the annual count data for MHWs and MCSs, general linear models (Poisson with log-link) were fitted to each >30 year time series. The slope of this line indicates whether after >30 years MHWs/MCSs are increasing or decreasing. As the OISST data set is over 30 years in duration, decadal trends were calculated for each OISST time series as seen in \Cref{table4}. We see that the mean (±SD) decadal trend for MHW occurrence in the OISST dataset is 0.2±0.1~dec$^{-1}$ across all sites and -0.3±0.3~dec$^{-1}$ for MCSs. The decadal trends in MHW occurrence increase as one moves from the colder Benguela fed west coast to warmer Agulhas driven east coast with the mean (±SD) decadal MHW trend on the west coast being 0.1±0.1~dec$^{-1}$, the south coast being 0.2±0.2~dec$^{-1}$ and the east coast at 0.3±0.1~dec$^{-1}$. Just as MHWs are occurring more frequently per decade on the east coast than the west, the count of MCSs is decreasing more on the east coast than the west. The decadal trend in MCSs on the west coast is 0.0±0.2~dec$^{-1}$, -0.4±0.2~dec$^{-1}$ on the south coast and -0.5±0.2~dec$^{-1}$ on the east coast.
...
Of the 21 \emph{in situ} time series, only four of them reach the >30 year requirement (\Cref{table4}). Of these four time series the mean (±SD) decadal trend for MHWs is 0.2±0.4~dec$^{-1}$ and -0.1±0.3~dec$^{-1}$ for MCSs. There are two sites from the west coast and two from the south, excluding the east coast from a possible calculation of decadal change for \emph{in situ} MHWs and MCSs. The mean (±SD) decadal trend for MHWs (MCSs) on the west coast is 0.0±0.3~dec$^{-1}$ (-0.2±0.5~dec$^{-1}$) and 0.4±0.4~dec$^{-1}$ (0.0±0.3~dec$^{-1}$) on the south. Note that none of the decadal trends for MCSs from the >30 year \emph{in situ} time series for the west coast were significant.
