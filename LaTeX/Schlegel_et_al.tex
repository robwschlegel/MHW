...
\bibpunct{(}{)}{;}{a}{}{,} % Disable this line when wanting to repopulate the .bbl file
...
As with the MHWs, the largest three MCSs from the \emph{in situ} data were also found on the south coast (\Cref{table5}). Maintaining the pattern seen with the MHWs, the largest MCSs on the west coast were the next largest three events for the entire coastline with the three largest MCSs from the east coast being smaller than the other two coastal sections (\Cref{table5}). The mean(sd) cumulative intensity (\degree C x days) for MCSs over the entire coastline was 26.45(24.25)(\degree C x days). The cumulative intensity (\degree C x days) of events from each of the coastal sections in the \emph{in situ} data were found to be significantly different (F=7.377, df\textsubscript{1}=2, df\textsubscript{2}=1444, \emph{p}<0.01) as well as the events themselves (F=1753, df\textsubscript{1}=1, df\textsubscript{2}=1444, \emph{p}<0.01).
...
The temperature values from the dates of the largest MHW and MCS for the west and south coasts from the \emph{in situ} data may be seen concurrently with the temperature values from the matching OISST time series in \Cref{fig:Figure3}. One may see that when the largest events were occurring in the \emph{in situ} data, nothing of note was occurring within the OISST data.
...
Another imporant consideration was the co-occurrence of the most extreme events between and within time series. As one may see in \Cref{table4} and \Cref{table5}, none of the top three MHWs or MCSs for any of the coastal sections from the \emph{in situ} dataset were the same. They were all inidvidually different events occurring at different times. The OISST dataset tells an entirely different story in that all but one of the coastal sections for both MHWs and MCSs, had at least two of the three top events occurring at the same time. This means that the largest events detected in the OISST data were occurring over a broad area at the same time whereas the \emph{in situ} events were isolated not only in time, but in the location in which they were occurring. This further reinfocres our conclusion that the events detected by the different datasets are intinsically different from one another.
...
\begin{thebibliography}{50} % Delete all of this when using the MHW.bbl file
\expandafter\ifx\csname natexlab\endcsname\relax\def\natexlab#1{#1}\fi
\expandafter\ifx\csname url\endcsname\relax
  \def\url#1{\texttt{#1}}\fi
\expandafter\ifx\csname urlprefix\endcsname\relax\def\urlprefix{URL }\fi

\bibitem[{Alexander et~al.(2006)Alexander, Zhang, Peterson, Caesar, Gleason,
  {Klein Tank}, Haylock, Collins, Trewin, Rahimzadeh, Tagipour, {Rupa Kumar},
  Revadekar, Griffiths, Vincent, Stephenson, Burn, Aguilar, Brunet, Taylor,
  New, Zhai, Rusticucci, and Vazquez-Aguirre}]{Alexander2006}
...
\bibitem[{{American Meteorological Society}(2011)}]{Glickman2000}
...
\bibitem[{Black et~al.(2004)Black, Blackburn, Harrison, Hoskins, and
  Methven}]{Black2004}
...
\bibitem[{Bond et~al.(2015)Bond, Cronin, Freeland, and Mantua}]{Bond2015}
Bond, N.~A., Cronin, M.~F., Freeland, H., Mantua, N., 2015. {Causes and impacts
  of the 2014 warm anomaly in the NE Pacific}.

\bibitem[{Castillo and Lima(2010)}]{Castillo2010}
...
\bibitem[{Chen et~al.(2015)Chen, Gawarkiewicz, Kwon, and Zhang}]{Chen2015}
...
\bibitem[{Chen et~al.(2014)Chen, Gawarkiewicz, Lentz, and Bane}]{Chen2014}
...
\bibitem[{DeCastro et~al.(2014)DeCastro, G{\~{o}}mez-Gesteira, Costoya, and
  Santos}]{DeCastro2014}
...
\bibitem[{Diaz and Rosenberg(2008)}]{Diaz2008}
...
\bibitem[{Easterling et~al.(2000)Easterling, Meehl, Parmesan, Changnon, Karl,
  and Mearns}]{Easterling2000}
...
\bibitem[{Feng et~al.(2013)Feng, McPhaden, Xie, and Hafner}]{Feng2013}
...
\bibitem[{Firth et~al.(2011)Firth, Knights, and Bell}]{Firth2011}
...
\bibitem[{Firth et~al.(2015)Firth, Mieszkowska, Grant, Bush, Davies, Frost,
  Moschella, Burrows, Cunningham, Dye, and Hawkins}]{Firth2015}
...
\bibitem[{Fischer et~al.(2011)Fischer, Lawrence, and Sanderson}]{Fischer2011}
...
\bibitem[{Fischer and Sch{\"{a}}r(2010)}]{Fischer2010}
...
\bibitem[{Garrabou et~al.(2009)Garrabou, Coma, Bensoussan, Bally,
  Chevaldonn{\'{e}}, Cigliano, Diaz, Harmelin, Gambi, Kersting, Ledoux,
  Lejeusne, Linares, Marschal, P{\'{e}}rez, Ribes, Romano, Serrano, Teixido,
  Torrents, Zabala, Zuberer, and Cerrano}]{Garrabou2009}
...
\bibitem[{Gershunov and Douville(2008)}]{Gershunov2008}
...
\bibitem[{Gunter(1941)}]{Gunter1941}
...
\bibitem[{Gunter(1951)}]{Gunter1951}
...
\bibitem[{Hobday et~al.(2016)Hobday, Alexander, Perkins, Smale, Straub, Oliver,
  Benthuysen, Burrows, Donat, Feng, Holbrook, Moore, Scannell, {Sen Gupta}, and
  Wernberg}]{Hobday2016}
...
\bibitem[{Holt and Holt(1983)}]{Holt1983}
...
\bibitem[{Hutchings et~al.(2009)Hutchings, van~der Lingen, Shannon, Crawford,
  Verheye, Bartholomae, van~der Plas, Louw, Kreiner, Ostrowski, Fidel, Barlow,
  Lamont, Coetzee, Shillington, Veitch, Currie, and Monteiro}]{Hutchings2009}
...
\bibitem[{Kreyling et~al.(2008)Kreyling, Beierkuhnlein, Ellis, and
  Jentsch}]{Kreyling2008}
...
\bibitem[{Laboy-nieves et~al.(2001)Laboy-nieves, Klein, Conde, Losada, Cruz,
  and Bone}]{Laboy-nieves2001}
...
\bibitem[{Lima and Wethey(2012)}]{Lima2012}
...
\bibitem[{L{\"{u}}nning(1990)}]{Luning1990}
...
\bibitem[{Lutjeharms et~al.(2000)Lutjeharms, Cooper, and
  Roberts}]{Lutjeharms2000}
...
\bibitem[{Mackenzie and Schiedek(2007)}]{Mackenzie2007}
...
\bibitem[{Marsh et~al.(1986)Marsh, O'Shea, and Best}]{Marsh1986}
Marsh, H., O'Shea, T.~J., Best, R.~C., 1986. {Research on Sirenians}. Ambio
  15~(3), 177--180.
\newline\urlprefix\url{http://www.jstor.org/stable/4313244}

\bibitem[{Matthes et~al.(2015)Matthes, Rinke, and Dethloff}]{Matthes2015}
...
\bibitem[{Mills et~al.(2012)Mills, Pershing, Brown, Chen, Chiang, Holland,
  Lehuta, Nye, Sun, Thomas, and Wahle}]{Mills2012}
...
\bibitem[{Olita et~al.(2007)Olita, Sorgente, Natale, Gaber{\v{s}}ek, Ribotti,
  Bonanno, and Patti}]{Olita2007}
...
\bibitem[{O'Shea et~al.(1985)O'Shea, Beck, Bonde, Kochman, and
  Odell}]{OShea1985}
...
\bibitem[{Pachauri et~al.(2014)Pachauri, Meyer, {Van Ypersele}, Brinkman, {Van
  Kesteren}, Leprince-Ringuet, and {Van Boxmeer}}]{IPCC2014}
...
\bibitem[{Rehage et~al.(2016)Rehage, Blanchard, Boucek, Lorenz, and
  Robinson}]{Rehage2016}
...
\bibitem[{Reynolds et~al.(2002)Reynolds, Rayner, and Smith}]{Reynolds2002}
...
\bibitem[{Reynolds et~al.(2007)Reynolds, Smith, Liu, Chelton, Casey, and
  Schlax}]{Reynolds2007}
...
\bibitem[{Selig et~al.(2010)Selig, Casey, and Bruno}]{Selig2010}
...
\bibitem[{Smale and Wernberg(2009)}]{Smale2009}
...
\bibitem[{Sura(2011)}]{Sura2011}
Sura, P., 2011. {A general perspective of extreme events in weather and
  climate}.

\bibitem[{Wernberg et~al.(2011)Wernberg, Russell, Moore, Ling, Smale, Campbell,
  Coleman, Steinberg, Kendrick, and Connell}]{Wernberg2011}
...
\bibitem[{Wernberg et~al.(2013)Wernberg, Smale, Tuya, Thomsen, Langlois,
  de~Bettignies, Bennett, and Rousseaux}]{Wernberg2013}
...
\end{thebibliography} % Delete this line when using the MHW.bbl file as well
