...
A Python script (https://github.com/ecjoliver/marineHeatWaves; see \citet{Hobday2016}) was used to calculate the MHWs and MCSs for both the \emph{in situ} and OISST time series. The individual events detected and their metrics were meaned into a series of annual values. These annual values were then meaned for each coastal section for later comparison.
